...
<head>
    ...
    <!-- CSS Files
    ================================================== -->
    <link href="{{ asset('client_assets/css/bootstrap.min.css') }}" rel="stylesheet" type="text/css" id="bootstrap">
    <link href="{{ asset('client_assets/css/mdb.min.css') }}" rel="stylesheet" type="text/css" id="mdb">
    <link href="{{ asset('client_assets/css/plugins.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('client_assets/css/style.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('client_assets/css/coloring.css') }}" rel="stylesheet" type="text/css">
    <!-- color scheme -->
    <link id="colors" href="{{ asset('client_assets/css/colors/scheme-01.css') }}" rel="stylesheet" type="text/css" />
    <!-- countdown -->
    <link id="colors" href="{{ asset('client_assets/css/jquery.countdown.css') }}" rel="stylesheet" type="text/css" />
</head>
    ...
    <div id="wrapper">
        ...
        <div class="no-bottom no-top" id="content">
            ...
            <section id="section-hero" class="jarallax text-light pt50 pb50 vertical-center" aria-label="section">
                <img src="{{ asset('client_assets/images/background/11.jpg') }}" class="jarallax-img" alt="">
                <div class="container">
