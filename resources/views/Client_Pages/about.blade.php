...
@section('authContent')
        ...
        <div class="no-bottom no-top zebra" id="content">
            ...
            <section aria-label="section" class="jarallax text-light">
                <img src="{{asset('client_assets/images/background/8.jpg')}}" class="jarallax-img" alt="">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 text-center">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 mb30">
                            <div class="f-profile text-center">
                                <div class="fp-wrap f-invert">
                                    ...
                                    <img src="{{asset('client_assets/images/team/1.jpg')}}" class="fp-image img-fluid" alt="">
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 mb30">
                            <div class="f-profile text-center">
                                <div class="fp-wrap f-invert">
                                    ...
                                    <div class="fpw-overlay-btm"></div>
                                    <img src="{{asset('client_assets/images/team/2.jpg')}}" class="fp-image img-fluid" alt="">
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 mb30">
                            <div class="f-profile text-center">
                                <div class="fp-wrap f-invert">
                                    ...
                                    <div class="fpw-overlay-btm"></div>
                                    <img src="{{asset('client_assets/images/team/3.jpg')}}" class="fp-image img-fluid" alt="">
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 mb30">
                            <div class="f-profile text-center">
                                <div class="fp-wrap f-invert">
                                    ...
                                    <div class="fpw-overlay-btm"></div>
                                    <img src="{{asset('client_assets/images/team/4.jpg')}}" class="fp-image img-fluid" alt="">
                                </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            ...
                            <img src="{{asset('client_assets/images/misc/car.png')}}" class="img-fluid wow fadeInUp" alt="">
                        </div>
