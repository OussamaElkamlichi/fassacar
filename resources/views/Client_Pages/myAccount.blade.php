                        ...
                        <div class="card p-4 rounded-5">
                            <div class="profile_avatar">
                                ...
                                <div class="profile_name">
                                    <h4>
                                        {{ $me->full_name }}
                                        <span class="profile_username text-gray">{{ $me->email }}</span>
                                    </h4>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="card p-4 rounded-5">
                            ...
                            <div class="de-item-list no-border mb30">
                                <div class="d-img">
                                    <img src="{{ asset('client_assets/images/cars/jeep-renegade.jpg') }}"
                                        class="img-fluid" alt="">
                                </div>
                                <div class="d-info">
                                    <div class="d-text">
                            ...
                            <div class="de-item-list no-border mb30">
                                <div class="d-img">
                                    <img src="{{ asset('client_assets/images/cars/bmw-m5.jpg') }}" class="img-fluid"
                                        alt="">
                                </div>
                                <div class="d-info">
                                    <div class="d-text">
                            ...
                            <div class="de-item-list no-border mb30">
                                <div class="d-img">
                                    <img src="{{ asset('client_assets/images/cars/ferrari-enzo.jpg') }}" class="img-fluid"
                                        alt="">
                                </div>
                                <div class="d-info">
                                    <div class="d-text">
