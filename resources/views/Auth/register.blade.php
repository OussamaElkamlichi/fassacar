            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 offset-md-2">
                        ...
                        <form class="form-border" method="post" action="{{ route('register') }}"  enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="">
                                    <div class="field-set">
                                        <label>Picture :</label>
                                        <input type='file' name='picture' id='re-password'
                                            class="form-control">
                                    </div>
                                    @error('picture')
                                    <p class="text-danger">{{ $message }}</p>
                                ...
                                <div class="col-md-12" style="margin-top: 10px">
                                    ...
                                    <div id='submit' class="pull-left"
                                        style="background-color: rgb(37, 157, 37)">
                                        <input type='submit' id='send_message'
                                            value='Register Now' class="btn-main color-2">
                                    </div>

                                    <div id='mail_success' class='success'>Your message has been
                                        sent successfully.</div>
                                    <div id='mail_fail' class='error'>Sorry, error occured this
                                        time sending your message.</div>
                                    <div class="clearfix"></div>
